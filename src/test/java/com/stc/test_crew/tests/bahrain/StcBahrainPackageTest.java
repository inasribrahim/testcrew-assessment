...
public class StcBahrainPackageTest extends BaseTest {
    private static final String JSON_FILE_NAME = "bahrainData.json";
    private static final String JSON_SUBDIRECTORY = "bahrain";
