...
public class StcKuwaitPackageTest extends BaseTest {
    private static final String JSON_FILE_NAME = "kuwaitData.json";
    private static final String JSON_SUBDIRECTORY = "kuwait";
